...
# Yealink Monitor Deployment Script
# This script automates the deployment of the Yealink phone monitoring service
...
echo_status "Starting Yealink Monitor deployment"

# Update system and install dependencies
echo_status "Updating system and installing dependencies"
apt update && apt upgrade -y
apt install -y python3 python3-pip python3-venv git arp-scan
